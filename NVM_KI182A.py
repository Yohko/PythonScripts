...
# connect to Keithley 2182A Nanovoltmeter through serial port and save readings to file
import time
import serial
import sys
import os
...
print('Reading data from \x1b[1;31;40mKeithley 2182A Nanovoltmeter\x1b[0m at',serialport)
